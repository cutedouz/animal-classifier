...
export const stage1Cards: Stage1Card[] = [
  {
    ...
    diagnosticFeatures: ['身體呈放射對稱', '口周有觸手', '觸手具有刺絲胞'],
    warning: '生活在水中不是最主要的分類依據，關鍵是刺絲胞與放射對稱。',
  },
  {
    id: 'P2',
    name: '海葵',
    ...
    phylum: '刺絲胞動物門',
    visibleHint: '第一次自由分類先不要看特徵；第二階段才會回頭整理。',
    diagnosticFeatures: ['身體呈放射對稱', '口部周圍有觸手', '觸手具有刺絲胞'],
  ...
  },
  {
    ...
    phylum: '棘皮動物門',
    visibleHint: '第一次自由分類先不要看特徵；第二階段才會回頭整理。',
    diagnosticFeatures: ['成體多呈五輻對稱', '身體表面有棘刺', '具有管足'],
    warning: '生活在海中不是主要分類依據，五輻對稱與管足更重要。',
  },
  {
    id: 'P9',
    name: '海星',
    ...
    phylum: '棘皮動物門',
    visibleHint: '第一次自由分類先不要看特徵；第二階段才會回頭整理。',
    diagnosticFeatures: ['成體多呈五輻對稱', '具有管足', '常見放射狀身體'],
    warning: '不要只看像星星的外形，關鍵仍是棘皮動物的五輻對稱與管足。',
  },
  {
    id: 'P10',
    name: '蝴蝶',
...
export const bridgeFeatureChoices: BridgeFeatureChoice[] = [
  ...
  { id: 'F5', text: '成體多呈五輻對稱', category: 'diagnostic' },
...
export const evidenceQuestions: EvidenceQuestion[] = [
  {
    ...
    prompt: '水母應該分類到哪一門？',
    stimulusText:
      '已知：身體呈放射對稱，口周有多條觸手，而且觸手具有刺絲胞。請依主要構造判斷，不要只看生活在水中。',
    imageUrl: '/animals/p1.jpg',
  ...
  },
  {
    ...
    prompt: '海葵應該分類到哪一門？',
    stimulusText:
      '已知：身體柔軟，口部周圍有觸手，觸手具有刺絲胞，而且成體呈放射對稱。請依主要構造判斷。',
    imageUrl: '/animals/p2.jpg',
    options: PHYLUM_OPTIONS,
  },
  {
  ...
  },
  {
    ...
    prompt: '海膽應該分類到哪一門？',
    stimulusText:
      '已知：成體多呈五輻對稱，身體表面有棘刺，而且具有管足。請依主要構造判斷，不要只看生活在海中。',
    imageUrl: '/animals/p8.jpg',
    options: PHYLUM_OPTIONS,
  },
  {
    ...
    prompt: '海星應該分類到哪一門？',
    stimulusText:
      '已知：成體多呈五輻對稱，具有管足，身體呈放射狀。請依棘皮動物的核心特徵判斷。',
    imageUrl: '/animals/p9.jpg',
    options: PHYLUM_OPTIONS,
  },
  {
